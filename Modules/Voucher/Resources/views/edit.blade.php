                            ...
                            <div class="row pt-3">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="code" id="firstName" value="{{ old('code', $voucher->code ?? '') }}" class="form-control" placeholder="VOUCHER..."  />
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3 has-success">
                                        ...
                                        <input type="number" id="" class="form-control" value="{{ old('amount', $voucher->amount ?? '') }}" name="amount"  />
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3 has-success">
                                        ...
                                        <input type="date" id="" class="form-control" value="{{ old('start_date', $voucher->start_date ?? '') }}" name="start_date"  />
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3 has-success">
                                        ...
                                        <input type="date" id="" class="form-control" value="{{ old('end_date', $voucher->end_date ?? '') }}" name="end_date"  />
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3 has-success">
                                        ...
                                        <input type="number" id="" class="form-control" value="{{ old('usage_limit', $voucher->usage_limit ?? '') }}" name="usage_limit" min="1" max="30"  />
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3 has-success">
                                        ...
                                        <input type="number" id="" class="form-control" value="{{ old('used', $voucher->used ?? '') }}" name="used"  />
                                    </div>
